// Synchronous SHA-256 for this synchronous command boundary. No Node-only API,
// browser dependency, or repeated full survey graph is persisted in an intent.
const K = [
...
export function soundingsSha256(text: string): string {
