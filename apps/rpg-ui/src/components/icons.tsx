...
export function Icon({ name, className = 'h-5 w-5' }: IconProps) {
  ...
  switch (name) {
    ...
    case 'gear':
      return (
        <svg {...shared}>
          <path d="M10.34 3.94c.09-.54.56-.94 1.11-.94h1.1c.54 0 1.02.4 1.1.94l.15.9c.68.29 1.3.68 1.84 1.16l.82-.33c.51-.2 1.1.04 1.32.55l.54 1.27c.22.51.01 1.11-.48 1.34l-.76.37c.08.69.08 1.4 0 2.09l.76.37c.49.23.7.83.48 1.34l-.54 1.27c-.22.51-.81.75-1.32.55l-.82-.33c-.54.48-1.16.87-1.84 1.16l-.15.9c-.08.54-.56.94-1.1.94h-1.1c-.55 0-1.02-.4-1.11-.94l-.15-.9a7 7 0 0 1-1.83-1.16l-.82.33c-.52.2-1.11-.04-1.32-.55l-.55-1.27a1.12 1.12 0 0 1 .49-1.34l.76-.37a8.7 8.7 0 0 1 0-2.09l-.76-.37a1.12 1.12 0 0 1-.49-1.34l.55-1.27c.21-.51.8-.75 1.32-.55l.82.33c.54-.48 1.15-.87 1.83-1.16l.15-.9Z" />
