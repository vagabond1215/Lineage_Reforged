...
Safest immediate next local Codex run: `Version 0.5.248 - First Polity Content Seed Plan`.
...
It should use the current polity schema and validator output as its source and remain docs-first seed planning only.
