...
Status: accepted coordination authority; DEV-0.7.0 complete; Soundings post-repair audit REPAIR_REQUIRED (F2); consumer completion witness gate repair active
...
- latest independent audit: `Soundings Durable Completion Post-Repair Independent Acceptance Audit`, `REPAIR_REQUIRED` at B1 (F2); A1 passed 68 cases;
