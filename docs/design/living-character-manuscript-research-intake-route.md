...
The intake originally selected `Version 0.5.345 - Force Public Order Authority Evidence Audit` as the return point. That primary route completed before these intake commits were merged. After the support route is completed, return the primary queue to:
...
- no `0.6.0` transition;
- no renumbering or displacement of the completed primary `0.5.345` route or current primary `0.5.346` route.
