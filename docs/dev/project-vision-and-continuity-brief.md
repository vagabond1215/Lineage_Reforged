...
Updated 2026-06-03 after `Version 0.5.98 - Magic Command Contract` landed.
...
- The next magic slice is a first narrow runtime cast resolver plan.
...
| `0.5.99` | First Narrow Runtime Cast Resolver Plan | Next. Plan the first narrow engine-owned resolver boundary. | Planning first; no UI dispatch, save mutation, resource payment, catalyst consumption, or event creation. |
...
Use the magic command contract plan for Version 0.5.99 - First Narrow Runtime Cast Resolver Plan.
