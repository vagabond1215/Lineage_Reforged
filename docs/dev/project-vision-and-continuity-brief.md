...
Updated 2026-07-28 after the Activity Resolution reuse audit was accepted and the Mortal Crisis receipt-contract decision was activated.
...
- Active run: unversioned `Functional State, Lethal Process, Care Requirement, And Mortal Crisis Receipt Contract Decision`.
...
- The Mortal Crisis receipt-contract prompt is installed in `docs/dev/current-codex-prompt.md`.
...
No new broad research is needed before the abstract Mortal Crisis receipt decision.
