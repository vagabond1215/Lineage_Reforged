...
- Latest completed support audit: `Version 0.6.9.10 - Durable Recovery Completion Lineage Post-Repair Acceptance Audit`, `PARENT_ACCEPTED`.
- Active run: the unversioned Ashen Reef survey receipt-foundation decision.
...
- `Version 0.6.9` is implemented and accepted after linked arbitrary-depth fork-lineage repair and committed-head validation.
