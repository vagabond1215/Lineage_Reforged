...
| Activity resolution reuse | active repository audit | Selection, trial, quest, Knowledge, crafting, magic, and occurrence foundations | Repository ownership/reuse audit | Accepted Geography plan and live route check | Run now; documentation only | `docs/dev/current-codex-prompt.md` |
