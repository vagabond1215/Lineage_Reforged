...
| Injury/trauma/Mortal Crisis/restoration | accepted conceptual-contract lane; static foundation implemented | Injury, Mortal Crisis, save, occurrence, functional/lethal/care/crisis receipt authority, research integration, care/observer contracts, dependency audit, owner/schema plan, version classification, and exact `0.6.8` implementation | Parent-specific `Version 0.6.8.1` acceptance audit | Six ids/four owners/nine paths implemented; focused/schema/combat-health checks and 71-file lint pass | Audit `Version 0.6.8`; mutable implementation remains `NO_PACKAGE` | `docs/dev/current-codex-output.md` |
