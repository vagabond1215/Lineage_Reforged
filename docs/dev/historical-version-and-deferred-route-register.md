...
| Injury/trauma/Mortal Crisis/restoration | accepted care-contract lane | Injury, Mortal Crisis, save, occurrence, functional/lethal/care/crisis receipt authority, grounded research integration, first catalog plan, and care-capability contract | Observer-safe assessment/presentation | Accepted care-capability contract | Run Observer-Safe Crisis Assessment And Presentation Contract Decision; implementation remains `NO_PACKAGE` | `docs/design/care-capability-stabilization-and-process-effect-contract-decision.md` |
