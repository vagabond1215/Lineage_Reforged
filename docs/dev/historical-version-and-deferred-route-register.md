...
| Injury/trauma/Mortal Crisis/restoration | active receipt contract | Injury, Mortal Crisis, save, occurrence, and accepted Activity audit | Functional/lethal/care/crisis receipts | Accepted Activity reuse audit | Run receipt contract; no catalog/runtime | `docs/dev/current-codex-prompt.md` |
