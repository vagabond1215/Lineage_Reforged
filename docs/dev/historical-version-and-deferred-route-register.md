...
| `0.6.10` | Ashen Reef Survey Advancement Authority | Implemented; pending independent parent audit | Commit `008db9c93eb8818aea51652be07fd196df41c45f` implements the bounded persisted four-stage owner/receipt/retry/repair/UI package; no parent or `0.7.0` acceptance claim. | `docs/design/ashen-reef-survey-occurrence-result-and-consequence-receipt-foundation-decision.md` |
| `0.6.10.1` | Ashen Reef Survey Advancement Acceptance Audit | Active support suffix | Independently audit `008db9c...`, decide parent and representative-loop acceptance, and keep band entry behind a separate docs-first decision. | `docs/dev/current-codex-prompt.md` |
...
| Activity resolution reuse | bounded survey implementation pending acceptance | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, exact survey owner/receipt decisions, accepted `0.6.9`, and implemented `0.6.10` at `008db9c...` | Independently accept the exact survey package and classify representative-loop evidence | Active `Version 0.6.10.1 - Ashen Reef Survey Advancement Acceptance Audit` | Keep rest, turn-in, generic activity, rewards, and direct `0.7.0` entry outside the audit | `docs/dev/current-codex-prompt.md` |
