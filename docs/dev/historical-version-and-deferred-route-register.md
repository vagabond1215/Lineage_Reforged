...
| `0.6.9` | Normal Stakes Campaign Persistence Foundation | Implemented; parent repair required | `0.6.9.5` closed the three `0.6.9.4` findings, but `0.6.9.6` proved initial automatic destination validation, restart duplicate recovery, and original effect provenance remain incomplete. | `docs/design/normal-stakes-campaign-persistence-foundation-acceptance-audit.md` |
...
| `0.6.9.7` | Initial Defeat Authority, Durable Duplicate, And Effect-Provenance Repair | Active support repair | Must share exact initial destination validation, close restart-safe duplicate identity, and reject corrupted original effect provenance. | `docs/dev/current-codex-prompt.md` |
