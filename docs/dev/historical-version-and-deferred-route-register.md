...
| `0.6.9` | Normal Stakes Campaign Persistence Foundation | Implemented and accepted through repair | Parent authority plus `0.6.9.2` recovery/admission evidence is green at 127/127 prescribed tests and a passing RPG UI build. | `docs/design/normal-stakes-campaign-persistence-foundation-acceptance-audit.md` |
| `0.6.9.1` | Normal Stakes Campaign Persistence Foundation Acceptance Audit | Completed; findings repaired | The six exact findings remain historical evidence for the accepted `0.6.9.2` repair. | `docs/design/normal-stakes-campaign-persistence-foundation-acceptance-audit.md` |
| `0.6.9.2` | Normal Campaign Publication Recovery Repair | Completed support suffix; accepted | Repaired all six findings, immutable address verification, and terminal account-consumer cleanup ordering without a generic transaction or replay framework. | `docs/design/normal-stakes-campaign-persistence-foundation-acceptance-audit.md` |
...
| Activity resolution reuse | survey/save contracts and `0.6.9` persistence authority accepted | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, exact survey owner contract, and accepted Normal persistence foundation | Decide the smallest persisted survey occurrence/result/consequence receipt foundation | Complete the active unversioned receipt decision | Keep general competence/difficulty/familiarity separate; do not implement survey during the decision | `docs/dev/current-codex-prompt.md` |
