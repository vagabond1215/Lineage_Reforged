...
| `0.6.9` | Normal Stakes Campaign Persistence Foundation | Complete and accepted | Accepted after the `0.6.9.9` durable lineage repair and `0.6.9.10` committed-head audit. | `docs/design/normal-stakes-campaign-persistence-foundation-acceptance-audit.md` |
...
| `0.6.9.10` | Durable Recovery Completion Lineage Post-Repair Acceptance Audit | Complete support audit; parent accepted | Focused `33/33`, prescribed `140/140`, lineage `15/15`, build and bounded type gates passed; parent `0.6.9` accepted. | `docs/dev/current-codex-output.md` |
...
| Activity resolution reuse | survey/save contracts and accepted Normal persistence foundation | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, exact survey owner contract, and accepted `0.6.9` persistence/lineage authority | Decide the persisted survey occurrence/result/consequence receipt foundation | Active unversioned survey receipt decision | Keep survey implementation blocked until the decision returns a bounded package | `docs/dev/current-codex-prompt.md` |
