...
| `0.6.11` | Ashen Reef Survey Ordinary Reachability And Representative Loop Evidence | Active authorized primary | `PACKAGE_READY`; implement the authored Starfall definition, initial offer owner, accepted-quest access owner, direct Starfall/Ashen origin correction, versioned presentation compatibility, and injection-free creator-to-restart evidence. | `docs/design/ashen-reef-survey-ordinary-reachability-implementation-package-decision.md` |
| `0.6.11.1` | Ashen Reef Survey Ordinary Reachability And Representative Loop Acceptance Audit | Reserved support audit | Install only after complete `0.6.11` implementation; production-read-only and independently decide parent/representative acceptance. | `docs/design/ashen-reef-survey-ordinary-reachability-implementation-package-decision.md` |
...
| Activity resolution reuse | bounded survey parent accepted; reachability package authorized | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, accepted `0.6.9`, accepted `0.6.10`, accepted Ashen canon, reusable travel-owned survey activation, and sufficient version-7 persistence | Implement and independently accept the bounded ordinary-reachability owners and injection-free evidence | Active `Version 0.6.11 - Ashen Reef Survey Ordinary Reachability And Representative Loop Evidence` | Keep turn-in/rewards, geographic Knowledge/map behavior, generic quest/activity/travel infrastructure, other Stakes modes, and direct `0.7.0` entry outside `0.6.11` | `docs/dev/current-codex-prompt.md` |
