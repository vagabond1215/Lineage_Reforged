...
| `Ashen Reef Survey Offer, Journal Admission, And Travel-Access Authored-Canon Decision` | Active documentation-only authored-input decision | Obtain explicit quest/place identity, issuer, availability/recurrence, journal-admission, and access-occurrence facts; fail closed rather than infer canon. | `docs/dev/current-codex-prompt.md` |
...
| Activity resolution reuse | bounded survey parent accepted; reachability package blocked on authored input | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, accepted `0.6.9`, accepted `0.6.10`, both bounded repairs, independent parent evidence, reusable travel-owned survey activation, and sufficient version-7 persistence | Explicit Ashen quest/place canon, offer timing/eligibility/recurrence, journal-admission owner, and known-location/access occurrence | Active `Ashen Reef Survey Offer, Journal Admission, And Travel-Access Authored-Canon Decision` | Keep production implementation, turn-in/rewards, geographic Knowledge/map behavior, generic quest/activity/travel infrastructure, other Stakes modes, provisional `0.6.11`, and direct `0.7.0` entry outside the authored-input decision | `docs/dev/current-codex-prompt.md` |
