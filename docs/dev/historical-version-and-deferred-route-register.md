...
| `0.6.5`-`0.6.7` | future repair suffix only when evidence requires | Remaining static content packages and cross-content audit | Active planned sequence | Item/material/recipe is active next, followed by monster/ecology/loot and the coherence audit. | `docs/design/static-content-expansion-program.md` |
