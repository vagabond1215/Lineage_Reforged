...
| Injury/trauma/Mortal Crisis/restoration | accepted research-integrated planning lane | Injury, Mortal Crisis, save, occurrence, functional/lethal/care/crisis receipt authority, and grounded research integration | Exact static catalog ownership/first scope, then care and observer contracts | Accepted research integration | Run First Lethal-Process Definition And Catalog Plan; executable work remains `NO_PACKAGE` | `docs/design/lethal-process-and-stabilization-research-integration-decision.md` |
