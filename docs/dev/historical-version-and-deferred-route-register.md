...
| `0.6.6` | Monster, Ecology, And Loot Static Content Expansion | Active and unblocked | Exact parent prompt restored after accepted `0.6.6.5`; execute in a separate pass. | `docs/dev/current-codex-prompt.md` blob `42014541c15d2d7ccc01f43dd8b0a4fa6fbf8769` |
...
| Static monster/ecology/loot | active parent primary | Exact matrix, closed references, accepted support chain, and restored parent prompt | Execute exact `0.6.6` | Accepted `0.6.6.5` | Run the restored parent package separately | `docs/dev/current-codex-prompt.md` |
