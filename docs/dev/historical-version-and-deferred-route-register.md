...
| Injury/trauma/Mortal Crisis/restoration | accepted conceptual-contract lane; dependency audit active | Injury, Mortal Crisis, save, occurrence, functional/lethal/care/crisis receipt authority, grounded research integration, first catalog plan, care-capability contract, and observer-safe assessment/presentation | Live owner/schema/persistence dependency closure | Accepted observer-safe contract and retired final research artifact | Run Health Runtime Ownership And Dependency Closure Audit; implementation remains `NO_PACKAGE` | `docs/design/observer-safe-crisis-assessment-and-presentation-contract-decision.md` |
