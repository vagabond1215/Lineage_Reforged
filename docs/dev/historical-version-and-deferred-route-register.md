...
| `Ashen Reef Survey Ordinary Reachability And Representative Loop Dependency Closure Decision` | Active documentation-only decision | Decide whether repository authority can close ordinary quest-offer, known-location, travel/activity, persistence, and injection-free creator-to-restart evidence as one bounded current-band package without inventing canon. | `docs/dev/current-codex-prompt.md` |
...
| Activity resolution reuse | bounded survey parent accepted; ordinary reachability decision active | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, accepted `0.6.9`, accepted `0.6.10`, both bounded repairs, and independent parent evidence | Production creator has no survey quest offer, Ashen Reef known-location authority, or survey activity; decide the smallest owner/canon package and injection-free representative test | Active `Ashen Reef Survey Ordinary Reachability And Representative Loop Dependency Closure Decision` | Keep implementation, turn-in/rewards, geographic Knowledge/map behavior, generic quest/activity/travel infrastructure, other Stakes modes, and direct `0.7.0` entry outside the decision | `docs/dev/current-codex-prompt.md` |
