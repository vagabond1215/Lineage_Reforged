...
| Injury/trauma/Mortal Crisis/restoration | accepted receipt contract; research gate active | Injury, Mortal Crisis, save, occurrence, Activity audit, and accepted functional/lethal/care/crisis receipt authority | Grounded lethal-process/stabilization evidence and repository integration | Accepted receipt-contract decision | Run `GPT-DR.health.lethal-process-stabilization`; no catalog/runtime | `docs/design/functional-state-lethal-process-care-requirement-and-mortal-crisis-receipt-contract-decision.md` |
