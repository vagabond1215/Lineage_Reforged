...
| `Integrated Gameplay 0.7 Band-Entry Readiness Decision` | Active installed docs-first decision | Evaluate every `0.7.x` entry criterion; return `BAND_ENTRY_READY` or `BAND_ENTRY_NOT_READY` without implementing or claiming `0.7.0`. | `docs/dev/current-codex-prompt.md` |
...
| Activity resolution reuse | representative loop accepted | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, accepted `0.6.9`, accepted `0.6.10`, accepted Ashen canon, implementation `3ca23d6864541a899ea61a6bf26257665f754e78`, and independent `0.6.11.1` `REPRESENTATIVE_LOOP_ACCEPTED` | Docs-first evaluation of every `0.7.x` entry criterion | Active `Integrated Gameplay 0.7 Band-Entry Readiness Decision` | Keep turn-in/rewards, geographic Knowledge/map behavior, generic quest/activity/travel infrastructure, other Stakes modes, and direct `0.7.0` implementation outside the decision | `docs/dev/current-codex-prompt.md` |
