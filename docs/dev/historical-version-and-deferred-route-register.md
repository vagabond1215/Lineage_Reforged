...
| Injury/trauma/Mortal Crisis/restoration | accepted catalog-planned lane | Injury, Mortal Crisis, save, occurrence, functional/lethal/care/crisis receipt authority, grounded research integration, and first catalog plan | Care-capability/process-effect contract, then observer-safe assessment/presentation | Accepted first catalog plan | Run Care Capability, Stabilization, And Process-Effect Contract Decision; implementation remains `NO_PACKAGE` | `docs/design/first-lethal-process-definition-and-catalog-plan.md` |
