...
| Activity resolution reuse | survey owner contract accepted; save prerequisite active | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, post-foundation classification, and exact Ashen Reef survey owner contract | Minimum Normal-only campaign/continuity identity, durable receipt authority, migration, and accepted-state publication; then exact survey implementation layers | Complete the active unversioned minimum save identity/publication decision | Keep general competence/difficulty/familiarity separate; survey implementation remains `NO_PACKAGE` | `docs/design/ashen-reef-survey-activity-advancement-scope-and-owner-contract-decision.md` |
