...
| `0.6.5` | none | Item, Material, And Recipe Static Content Expansion | Active next with revised exact target | Add the synthesis-owned 16-row batch from the unchanged 12-recipe baseline; keep explicit fields independent of chain/workplace resolver behavior. | `docs/design/cross-domain-production-research-synthesis.md` |
...
| Static item, material, and recipe content | implementation-ready | Large item/value catalog, 12 recipes, schemas, validators, tools, workplaces, skills, and chains | Exact 16-row batch, 28-recipe/10-family target, `bounded_design_inference`, and resolver quarantine | Accepted synthesis | Active revised `0.6.5`; do not restore failed pastry/meat-pie rows | `docs/design/cross-domain-production-research-synthesis.md` |
| Cross-domain sources, materials, production, and magitech research | complete; artifacts dispositioned | Items, values, flora, fauna, monsters, ecology, recipes, chains, tools, workplaces, crystals, spells, and magic infrastructure foundations | Durable synthesis and later owner-specific routes | Seven gates and integration accepted | Support `0.6.5`/`0.6.7` only through named consumers | `docs/design/cross-domain-production-research-synthesis.md` |
