...
| `0.6.10` | Ashen Reef Survey Advancement Authority | Implemented and repaired once; still unaccepted | Commit `008db9c93eb8818aea51652be07fd196df41c45f` implements the bounded persisted four-stage package; support repair `59af92629a79e95fa20247959159e336a8dbc88e` closed the first six findings, but `0.6.10.3` proved two residual authority defects. | `docs/design/ashen-reef-survey-occurrence-result-and-consequence-receipt-foundation-decision.md` |
...
| `0.6.10.4` | Ashen Reef Survey Progression Coherence And Projection Placement Repair | Active support suffix | Repair only owner-recomputed progression coherence and content-correct projection placement, preserve every passing contract, and install a separate production-read-only re-audit. | `docs/dev/current-codex-prompt.md` |
...
| Activity resolution reuse | bounded survey parent under second repair | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, exact survey owner/receipt decisions, accepted `0.6.9`, implemented `0.6.10`, first audit/repair, and `0.6.10.3` residual findings | Repair owner-derived progression coherence and exact projection placement, then independently accept the parent before representative-loop review | Active `Version 0.6.10.4 - Ashen Reef Survey Progression Coherence And Projection Placement Repair` | Keep rest, turn-in, generic activity, rewards, geographic Knowledge implementation, creator reachability, parent acceptance inside repair, and direct `0.7.0` entry outside the repair | `docs/dev/current-codex-prompt.md` |
