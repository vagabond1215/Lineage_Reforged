...
| `0.6.9` | Normal Stakes Campaign Persistence Foundation | Implemented; acceptance reopened | `cbad987` conforms to the bounded historical-edge decision, but parent acceptance awaits independently installed `0.6.9.11`. | `docs/design/historical-recovery-fork-evidence-verifiability-and-parent-acceptance-reopening-decision.md` |
...
| `0.6.9.11` | Historical Recovery Fork Authority Acceptance Audit | Active support audit | Must independently reproduce Model C and the complete parent validation gate before acceptance. | `docs/dev/current-codex-prompt.md` |
...
| Activity resolution reuse | survey/save contracts and implemented Normal persistence foundation | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, exact survey owner contract, and bounded historical-fork decision | Independently accept `0.6.9` through `0.6.9.11`, then decide the persisted survey receipt foundation | Survey decision blocked pending active `0.6.9.11` | Keep survey implementation blocked until parent acceptance and the decision return a bounded package | `docs/dev/current-codex-prompt.md` |
