...
| `0.6.9` | Normal Stakes Campaign Persistence Foundation | Implemented; repair blocked pending focused decision | `0.6.9.7` reproduced all nine hardened findings but stopped before production edits because non-head receipt continuity and sole-known destination provenance require explicit contract authority. | `docs/design/normal-stakes-campaign-persistence-foundation-acceptance-audit.md` |
...
| `0.6.9.7` | Initial Defeat Authority, Durable Duplicate, And Effect-Provenance Repair | Implementation incomplete; focused contract decision required | All nine hardened findings reproduced at `6820ab8`; production edits stopped because non-head receipt-continuity ownership and sole-known destination provenance are undecided. Resume only after the active focused decision reauthorizes the exact shared-contract surface. | `docs/dev/current-codex-output.md` |

## Current Unversioned Decision

| Run | Status | Required disposition | Primary source |
| --- | --- | --- | --- |
| `Normal Defeat Recovery Continuity And Destination Provenance Contract Decision` | Active | Decide non-head pending-receipt continuity ownership and truthful sole-known destination provenance, then reinstall revised `0.6.9.7`; do not install `0.6.9.8`. | `docs/dev/current-codex-prompt.md` |
...
| Activity resolution reuse | survey/save contracts and implemented Normal persistence repairs | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, exact survey owner contract, and implemented Normal persistence foundation | Decide non-head recovery continuity and sole-known destination provenance, complete revised `0.6.9.7`, independently audit, then decide the persisted survey occurrence/result/consequence receipt foundation | Independent acceptance after revised `0.6.9.7` | Block survey receipt and implementation until the parent persistence chain is independently accepted | `docs/dev/current-codex-prompt.md` |
