...
| `0.6.10` | Ashen Reef Survey Advancement Authority | Implemented and repaired twice; still unaccepted | Commit `008db9c93eb8818aea51652be07fd196df41c45f` implements the bounded persisted four-stage package; support repairs `59af92629a79e95fa20247959159e336a8dbc88e` and `07c57392c8078927e4f9e12efe18d8d89bb1fc70` address all eight findings, pending independent `0.6.10.5`. | `docs/design/ashen-reef-survey-occurrence-result-and-consequence-receipt-foundation-decision.md` |
...
| `0.6.10.5` | Ashen Reef Survey Progression And Projection Post-Repair Acceptance Audit | Active support suffix | Independently re-audit both residual repairs and every retained parent contract; decide parent acceptance first, then issue the exact representative-loop classification from ordinary production reachability evidence. | `docs/dev/current-codex-prompt.md` |
...
| Activity resolution reuse | bounded survey parent pending second re-audit | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, exact survey owner/receipt decisions, accepted `0.6.9`, implemented `0.6.10`, both bounded repairs, and the retained positive matrix | Independently verify owner-derived progression and exact projection placement, accept or reject the parent, then classify representative-loop evidence only after acceptance | Active `Version 0.6.10.5 - Ashen Reef Survey Progression And Projection Post-Repair Acceptance Audit` | Keep production repair, rest, turn-in, generic activity, rewards, geographic Knowledge implementation, other Stakes modes, and direct `0.7.0` entry outside the audit; creator reachability is evidence-only unless parent passes | `docs/dev/current-codex-prompt.md` |
