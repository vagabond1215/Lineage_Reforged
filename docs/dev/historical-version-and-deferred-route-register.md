...
| `0.6.9.3` | New-Campaign Retry, Slot-Recovery Collision, And Pending-Defeat Repair Completion | Active support repair | Must close the exact remaining parent defects before the survey receipt decision resumes. | `docs/dev/current-codex-prompt.md` |
...
| Activity resolution reuse | survey/save contracts and partial `0.6.9` persistence authority implemented | Selection, trial, quest, Knowledge, crafting, magic, occurrence foundations, exact survey owner contract, and implemented Normal persistence foundation | Complete and accept `0.6.9.3`, then decide the persisted survey occurrence/result/consequence receipt foundation | Parent repair acceptance | Block survey receipt and implementation until the parent persistence chain is accepted | `docs/dev/current-codex-prompt.md` |
