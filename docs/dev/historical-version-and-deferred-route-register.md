...
| `0.6.9` | Normal Stakes Campaign Persistence Foundation | Implemented; revised repair reauthorized | The focused contract decision accepted additive completion-continuity and sole-known destination provenance; revised `0.6.9.7` is active and parent acceptance remains pending. | `docs/design/normal-stakes-campaign-persistence-foundation-acceptance-audit.md` |
...
| `0.6.9.7` | Initial Defeat Authority, Durable Duplicate, And Effect-Provenance Repair | Active revised support implementation | All nine hardened findings remain in scope. The accepted focused decision preserves original receipt continuity, adds completion continuity and `sole_known_settlement`, and reauthorizes the exact repair surface. | `docs/dev/current-codex-prompt.md` |
