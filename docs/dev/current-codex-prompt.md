...
- Primary route after integration: `Version 0.5.345 - Force Public Order Authority Evidence Audit`.
...
Use the existing force/public-order audit scope and guardrails from repository history. Do not perform that audit in this support run.
...
- `0.5.345` restored as the next prompt after integration;
