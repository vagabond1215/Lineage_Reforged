...
Date: 2026-06-15
Route: Codex local sequencing alignment after `Version 0.5.158 - 0.5.x Roadmap Integration Pass`
...
- The exact Flora registry alignment landed in `0.5.159` without broadening into runtime behavior.
- Keep the Knowledge Trial Readiness Policy Schema Plan as the immediate `0.5.160` direction.
...
| 82 | `0.5.160` | Knowledge Trial Readiness Policy Schema Plan | Codex 5.5 Local docs-first | `docs/design/knowledge-trial-schema-plan.md` | planning doc | Next | Select readiness policy schema/content ownership and guardrails without implementing readiness, mutable trial state, helpers, storage, UI, runtime, or gameplay behavior. |
...
The family, religion, ecology, recipe, crafting, civil-society, maturation, and estate documents remain future roadmap material only. They do not authorize implementation, and `0.5.160` must not absorb those systems.
...
- Keep `Version 0.5.160 - Knowledge Trial Readiness Policy Schema Plan` as the immediate next recommended run.
- Treat the completed registry alignment as content-lint authority only; it does not make Knowledge trials runnable.
- Do not mix `0.5.160` with family, heir, religion, ecology, recipe, crafting, civil-society, maturation, estate, Skill Trial, or Magic Study implementation.
