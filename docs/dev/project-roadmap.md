...
- Latest completed version: `Version 0.5.175 - Religious Hotspot Content Authority Schema And Validator`
- Next recommended version: `Version 0.5.176 - Religious Hotspot Content Authority Seed Plan`
...
- `Version 0.5.176 - Religious Hotspot Content Authority Seed Plan` is the next recommended narrow planning run.
- Do not roll from `0.5.175` to `0.6.0` unless the actual `0.6.x` runtime ownership milestone has been reached.
...
| `0.5.176` | Religious Hotspot Content Authority Seed Plan | Codex Local docs-first | Planning | Recommended next. Select exact first hotspot seed records now that schema and focused validation exist. | Documentation only unless explicitly rescoped; do not add live content, normal lint registration, direct snippet subject support, snippets, favorability/alignment, runtime, UI, or gameplay behavior. |
...
1. `0.5.176 - Religious Hotspot Content Authority Seed Plan`
2. `0.5.177 - Religious Hotspot Content Authority Seed`
3. `0.5.178 - Religious Hotspot Knowledge Subject Vocabulary Plan`
4. `0.5.179 - Religious Hotspot Knowledge Subject Schema And Validator`
5. `0.5.180 - Religious Hotspot Knowledge Snippet Seed Plan`
...
- `Version 0.5.176 - Religious Hotspot Content Authority Seed Plan` is the immediate next recommended run.
- The completed registry alignment remains content-lint authority only and does not make Knowledge trials runnable.
- Keep `0.5.176` to hotspot content-authority seed planning; do not absorb live content implementation, snippets, favorability/alignment mechanics, runtime, family, heir, recipe, crafting, estate, survival/builder/MMO gap work, Skill Trial, or Magic Study work.
...
| 85 | `0.5.176` | Religious Hotspot Content Authority Seed Plan | `docs/design/religious-hotspot-content-authority-schema-plan.md` | Next |
