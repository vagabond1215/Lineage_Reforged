...
- Latest completed version: `Version 0.5.223 - Person vs NPC Schema Decision`
- Next recommended version: `Version 0.5.224 - Magic Study Source Schema Decision`
...
- Do not roll from `0.5.223` to `0.6.0` unless a dedicated runtime-readiness decision confirms the actual `0.6.x` ownership milestone.
...
| `0.5.224` | Magic Study Source Schema Decision | Codex Local docs-first | Planning | Recommended next. Define study-source references and forbidden state. | Documentation only. |
