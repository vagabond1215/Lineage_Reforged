...
- Latest completed version: `Version 0.5.161 - Knowledge Trial Readiness Policy Schema`
- Next recommended version: `Version 0.5.162 - Ecology Knowledge Domain Plan`
...
- `Version 0.5.161 - Knowledge Trial Readiness Policy Schema` added the strict owner-free readiness record and focused structural coverage.
- `Version 0.5.162 - Ecology Knowledge Domain Plan` is the next recommended documentation-only run.
...
| `0.5.162` | Ecology Knowledge Domain Plan | Codex Local docs-first | Planning | Next. Define the first Ecology domain boundary and later seed-content sequence. | Documentation only; no registry content, snippets, schemas, validators, runtime, UI, storage, events, or gameplay behavior. |
...
- `Version 0.5.162 - Ecology Knowledge Domain Plan` is the immediate next recommended run.
- The completed registry alignment remains content-lint authority only and does not make Knowledge trials runnable.
- Do not absorb registry content, snippets, validators, runtime, family, heir, religion, recipe, crafting, estate, Skill Trial, or Magic Study implementation into `0.5.162`.
...
| 71 | `0.5.162` | Ecology Knowledge Domain Plan | `docs/design/family-religion-ecology-civil-society-expansion-plan.md` | Next |
