...
- Latest completed version: `Version 0.5.222 - Quest Objective And Condition Schema Decision`
- Next recommended version: `Version 0.5.223 - Person vs NPC Schema Decision`
...
- Do not roll from `0.5.222` to `0.6.0` unless a dedicated runtime-readiness decision confirms the actual `0.6.x` ownership milestone.
...
| `0.5.223` | Person vs NPC Schema Decision | Codex Local docs-first | Planning | Recommended next. Define stable person identity and NPC overlay contracts. | Documentation only. |
