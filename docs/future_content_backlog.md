...
- Prerequisite: semantic validation has landed; next define the evidence contract, then progress state, pure completion/progression helpers, and later trial/checkpoint integration
