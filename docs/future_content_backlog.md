...
- Prerequisite: evidence and progress contracts, schemas, pure semantic validators, rules planning, the pure evidence-to-progress proposal helper, and the evidence-producer plan have landed; next add only the narrow pure observation candidate helper before storage/persistence planning, progress-record initialization, completion behavior, and later trial/checkpoint integration
