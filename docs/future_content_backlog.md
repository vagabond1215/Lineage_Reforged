...
- Prerequisite: semantic validation and evidence contract planning have landed; next plan and implement the evidence schema, then define progress state, evidence-to-progress rules, completion behavior, and later trial/checkpoint integration
