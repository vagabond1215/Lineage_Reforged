...
- Prerequisite: semantic validation, evidence contract planning, evidence schema planning, the evidence record schema, and evidence semantic-validator planning have landed; next implement the focused evidence semantic validator before defining progress state, evidence-to-progress rules, completion behavior, and later trial/checkpoint integration
