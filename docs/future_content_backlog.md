...
- Intended implementation:
  ...
  - the character creator now also uses authored region card art and explicit presentation overrides for the first Kaelvar region trio while settlement cards remain on the older art-light presentation
