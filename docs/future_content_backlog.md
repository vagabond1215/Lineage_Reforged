...
- Prerequisite: registry seed data, semantic validation, skill-reference realignment, knowledge snippet content, evidence/progress contracts, pure completion/progression helpers, and later trial/checkpoint integration
