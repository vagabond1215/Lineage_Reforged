...
- Prerequisite: semantic validation, evidence contract planning, and evidence schema planning have landed; next implement the evidence record schema, then plan and implement semantic validation before defining progress state, evidence-to-progress rules, completion behavior, and later trial/checkpoint integration
